...
const Add = ({ url }) => {
    ...
    const [data, setData] = useState({
        ...
        price: "",
        category: "Salad",
        calorie: ""  // Added calorie to initial state
    });
    ...
    const onSubmitHandler = async (event) => {
        ...
        formData.append("calorie", Number(data.calorie));  // Updated to use calories
        ...
        try {
            ...
            if (response.data.success) {
                setData({
                    ...
                    price: "",
                    category: "Salad",
                    calorie: ""  // Reset calorie on success
                });
                setImage(false);
        ...
        <div className='add'>
            <form className='flex-col' onSubmit={onSubmitHandler}>
                ...
                <div className="add-category-price">
                    ...
                    <div className="add-price flex-col">
                        <p>Calorie</p>
                        <input className='inputclasa' onChange={onChangeHandler} value={data.calorie} type="number" name='calorie' placeholder='20' required />
                    </div>
                </div>
